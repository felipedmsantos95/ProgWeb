...
class CursoController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        $count = User::find()->where(['id_curso' => $model->id])->count();
    ...
    public function actionUsers($id){
        ...
        $listaUsuarios = new ActiveDataProvider(['query' => User::find()->where(['id_curso' => $model->id])]);

        return $this->render('listadeusuarios', [
            'model'=> $model,
    ...
    protected function findModel($id)
    {
        if (($model = Curso::findOne($id)) !== null) {
            ...
            return Curso::findOne(['sigla' => 'FT05']);
